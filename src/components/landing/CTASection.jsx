export default function CTASection() {
  return (
    <section id="menu" className="w-full px-6 py-24 bg-white dark:bg-zinc-950">
      <div className="max-w-5xl mx-auto rounded-3xl bg-gradient-to-br from-indigo-600 via-violet-600 to-purple-700 px-8 py-16 md:px-16 flex flex-col items-center gap-8 text-center relative overflow-hidden shadow-2xl shadow-indigo-500/20">
        {/* Decorative blobs */}
        ...
        <div className="relative">
          <p className="text-indigo-100 text-xs font-bold uppercase tracking-widest mb-4">
            Mari Berkontribusi
          </p>
        ...
        <p className="relative text-indigo-100 text-lg leading-relaxed max-w-xl">
        ...
        <div className="relative flex flex-col sm:flex-row gap-4 pt-4">
          <a
            href="/login"
            className="flex h-14 items-center justify-center rounded-full bg-white px-8 text-base font-bold text-indigo-600 hover:bg-indigo-50 hover:scale-105 transition-all shadow-xl"
          >
            Lapor Sekarang →
          </a>
          <a
