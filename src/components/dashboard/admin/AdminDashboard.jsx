      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900 tracking-tight">
            {greeting}, <span className="text-indigo-600">{userData?.username || 'Admin'}</span>! 👋
          </h1>
        ...
        <div className="flex items-center gap-2">
          <Link
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-tr from-indigo-600 to-indigo-500 hover:from-indigo-700 hover:to-indigo-600 text-white text-sm font-bold rounded-xl shadow-md shadow-indigo-600/20 hover:shadow-lg hover:shadow-indigo-600/30 transition-all duration-200 hover:scale-[1.02]"
          >
            <Eye size={16} />
            Lihat Semua Laporan
          </Link>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
            <div className="flex items-center justify-between p-6 border-b border-gray-100">
              ...
              <Link href={`${basePath}/laporan`} className="text-xs font-bold text-indigo-600 hover:text-indigo-700 transition-colors flex items-center gap-1">
                Lihat Semua
                <ArrowRight size={14} />
              </Link>
            </div>
          ...
          <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm space-y-5">
            ...
            <div className="space-y-3.5">
              ...
              <div className="space-y-2">
                ...
                <div className="w-full h-2 bg-gray-100 rounded-full overflow-hidden">
                  <div className="h-full bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-full transition-all duration-1000" style={{ width: `${stats.totalLaporan > 0 ? (stats.selesai / stats.totalLaporan) * 100 : 0}%` }} />
                </div>
              </div>
